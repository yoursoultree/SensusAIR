...
FREContext SensusAIRCtx = nil;


@implementation SensusAIR

#pragma mark - Singleton

static SensusAIR *sharedInstance = nil;
...
{
    NSLog(@"Entering SensusAIRExtInitializer()");

    *extDataToSet = NULL;
    *ctxInitializerToSet = &ContextInitializer;
    *ctxFinalizerToSet = &ContextFinalizer;

    NSLog(@"Exiting SensusAIRExtInitializer()");
}
...
{
    NSLog(@"Entering SensusAIRExtFinalizer()");

    // Nothing to clean up.
    NSLog(@"Exiting SensusAIRExtFinalizer()");
    return;
}
